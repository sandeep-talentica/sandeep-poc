...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "empTransactionManager", basePackages = { "com.emp.repositories" })
public class EmpPersistenceConfig {
	...
	public DataSource dataSourceDev() {
		...
		dataSource.setDriverClassName(env.getProperty("emp.datasource.driverClassName"));
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factory.setPackagesToScan("com.emp.entity");
