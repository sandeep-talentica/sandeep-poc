...
public class RequestTime {
	...
	public String getRequestStringToLog(HttpServletRequest request) {
		...
		if ( !uri.contains("/resources/") && !uri.contains("/bundle/") && !uri.contains("/api/v1/")) {
			...
			StringBuilder printRequest = new StringBuilder();
			...
			printRequest.append(" [" + handlingTimePerformanceStatus(handlingTime) + "]");
